...
**Canonical policy:** [`retailpulses/rp-governance-kit` → `docs/WORKTREE_AND_SESSION_GOVERNANCE.md`](https://github.com/retailpulses/rp-governance-kit/blob/__REF__/docs/WORKTREE_AND_SESSION_GOVERNANCE.md)
